    ...
    <CustomerLayout>
      <div className={"bg-blue-800 leading-relaxed text-white"}>
        <div className={"m-auto max-w-5xl p-5 font-lora"}>
          ...
          <p>
            Yahtzmen Furnishings operates the Yahtzmen.com website, which
          ...
          <p>
            ...
            anyone decided to use our Service, the Yahtzmen Furnishings website.
          </p>
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at Yahtzmen.com,
