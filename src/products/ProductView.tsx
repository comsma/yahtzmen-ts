                    ...
                    <div className="lg:grid lg:grid-cols-12 lg:auto-rows-min lg:gap-x-8">
                        ...
                        <div className="mt-8 lg:col-span-5">
                            <form>
                                <button
                                    type="submit"
                                    className="mt-8 w-full bg-primary border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                >
                                    Add to cart
                                </button>
                            </form>
