    ...
    return (
        <header className="bg-blue-800 font-lora text-golden-rod top-0 sticky z-50">
            <nav className="px-4 sm:px-6 lg:px-8 relative" aria-label="Top">
                <div className="py-3 ">
                    <div className="grid grid-cols-1 grid-rows-3 gap-5 py-2 min-h-20 m-auto w-full lg:grid-cols-7 lg:grid-rows-1">
                        ...
                        <div className="mx-4 col-span-1 row-start-2 lg:col-span-2 lg:row-start-1 lg:col-start-5">
                        ...
                        <div className={'mx-4 justify-self-center col-start-0 row-start-3 col-span-1 lg:row-start-1 lg:col-start-7 lg:justify-self-end'}>
                            <Link href={'/Cart'}>
