      ...
      <div className={"min-h-screen"}>
        ...
        <div className={"mx-5 grid grid-cols-4 items-start gap-5 p-5"}>
          ...
          >
            ...
            >
              <div>
                <span className={"font-3xl font-bold"}>Subtotal:</span>
              </div>
              <div>
                <span className={"font-lg font-normal"}>${subtotal}</span>
              </div>
            </div>
